...
if __name__ == '__main__':
    ...
    train_ids = pd.read_csv(r'D:\mnt\meta_process\meta_dataset/train_ids.csv')
    val_ids = pd.read_csv(r'D:\mnt\meta_process\meta_dataset/val_ids.csv')
    ...
    train_set = MyDataset(ids=train_ids,
                          stimuli_dir=r'D:\mnt\meta_process\meta_dataset\train\train_stimuli/',
                          saliency_dir=r'D:\mnt\meta_process\meta_dataset\train\train_saliency/',
                          fixation_dir=r'D:\mnt\meta_process\meta_dataset\train\train_fixation/',
    ...
    val_set = MyDataset(ids=val_ids,
                        stimuli_dir=r'D:\mnt\meta_process\meta_dataset\val\val_stimuli/',
                        saliency_dir=r'D:\mnt\meta_process\meta_dataset\val\val_saliency/',
                        fixation_dir=r'D:\mnt\meta_process\meta_dataset\val\val_fixation/',
                        transform=transforms.Compose([
                            transforms.Resize((288, 512)),
                            transforms.ToTensor(),
                            transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
